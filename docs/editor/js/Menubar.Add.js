...
import { UICanvasMediator } from './canvas/UICanvasMediator.js';
...
function MenubarAdd( editor ) {
	...
	option.onClick( function () {
		...
		UICanvasMediator.request( editor, 'Button' );
		console.log( 'UI / Button selected' );
	...
	option.onClick( function () {
		...
		UICanvasMediator.request( editor, 'Image' );
		console.log( 'UI / Image selected' );
